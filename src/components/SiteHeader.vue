...
<template>
  <header class="z-10 container mx-auto grid grid-cols-[1fr_auto] items-start gap-y-1 px-4 py-8 md:py-12 xl:py-18"
    @keydown.esc="closeMenu">
    <div>
      <a href="/">
        <h1 class="-mt-2 mb-1 text-4xl font-bold sm:text-7xl lg:text-8xl" style="margin-left: -0.07em">
          Real-O-Mat
        </h1>
      </a>
    </div>
    <div class="col-start-2 row-start-1 flex flex-row items-center gap-2 md:gap-6 xl:hidden">
      <a href="https://fragdenstaat.de/jetzt-spenden/?pk_campaign=realomat" target="_blank"
        ...
        <IconHeart aria-hidden="true" class="me-1 inline-block text-2xl md:text-base" />
    ...
    <div class="col-span-2">
      <span class="text-lg font-medium text-purple-800 md:text-xl" v-if="props.election">
        {{ props.election.title }}
      </span>
      <div class="flex items-end text-lg font-medium md:text-xl" v-else>
        <p>Ein Projekt von</p>
